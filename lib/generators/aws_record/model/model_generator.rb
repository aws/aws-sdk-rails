  ...
  module Generators
    ...
    class ModelGenerator < Rails::Generators::NamedBase
      ...
      def parse_attributes!
        ...
        attributes << GeneratedAttribute.new('password_digest', :string_attr, digest: true) if options['password_digest']
      ...
      def ensure_unique_fields
        ...
        attributes.each do |attr|
          ...
          # db attribute names are wrapped with single quotes to make template generation easier
