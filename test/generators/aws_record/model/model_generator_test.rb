  ...
  module Generators
    ...
    class ModelGeneratorTest < Rails::Generators::TestCase
      ...
      def test_model_set_table_name
        run_generator %w[TestModelSetTableName --table-config=primary:5-2 --table-name=CustomTableName]
      ...
      def test_table_config_model1_config
        expect do
          run_generator %w[TestTableConfigModel1 uuid:hkey]
        end.to raise_error(SystemExit)
      end

      def test_table_config_model2_config
        run_generator %w[TestTableConfigModel2 --table-config=primary:20-10 -f]
